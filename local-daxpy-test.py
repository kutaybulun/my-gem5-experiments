...
binary = BinaryResource(local_path="/home/kutaybulun/Repos/my-gem5-experiments/workloads/daxpy/daxpy-gem5")
...
simulator_inorder = Simulator(board=board_inorder, id="inorder-daxpy")
