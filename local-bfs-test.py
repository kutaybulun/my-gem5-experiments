...
binary = BinaryResource(local_path="/home/kutaybulun/Repos/my-gem5-experiments/workloads/breadFirstSearch/bfs")
...
simulator_inorder = Simulator(board=board_inorder, id="inorder-bfs")
